...
#
#     PHX_SERVER=true bin/latchkey start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :latchkey, LatchkeyWeb.Endpoint, server: true
end
  ...
  config :latchkey, LatchkeyWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/latchkey_web/router\.ex$"E,
        ~r"lib/latchkey_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :latchkey, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :latchkey, Latchkey.Mailer,
