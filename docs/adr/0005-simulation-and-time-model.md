...
**Envelope date semantics (decisions 3–4) superseded by
[ADR 0006](0006-tenancy-timeline-read-model.md)** — `effective_date` is renamed
`occurred_on` (occurrence, uniform) and kick-in dates are payload; this body is
left unchanged, only this Status pointer is added.
